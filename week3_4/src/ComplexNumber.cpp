...
ostream& operator<<(ostream& output,const ComplexNumber& z){
...
ComplexNumber ComplexNumber::CalculateConjugate() const{
	double conjugateImaginaryPart = -mImaginaryPart;
	ComplexNumber z(mRealPart, conjugateImaginaryPart);
	return z;
}
...
ComplexNumber ComplexNumber::operator/(const ComplexNumber& z) const{
	ComplexNumber w;
	w.mRealPart = (mRealPart * z.mRealPart + mImaginaryPart * z.mImaginaryPart) / pow(z.mRealPart, 2) + pow(z.mImaginaryPart, 2);
	w.mImaginaryPart = (mImaginaryPart*z.mRealPart - mRealPart*z.mImaginaryPart) / pow(z.mRealPart, 2) + pow(z.mImaginaryPart, 2);
	return w;
}
